...
export default function Service(){
    ...
    return(
        ...
        <div className='lg:grid lg:flex lg:p-4 pt-6'>
            <div className='lg:col-6'>
            <img alt="home" src={potrait1} className='border-round-3xl max-w-full pot-1 px-4 lg:px-0' />
            </div>
            <div className='lg:col-6 pot-txt'>
            <h2 className='pl-5 text-3xl font-medium'>A Few Words About Us</h2>
                <h2 className='text-lg font-normal px-5'>There are always situations that call for more than just a photograph. Have your portrait painted by a really experienced fine artist who can literally paint anything you can dream up! A portrait is a representation of a particular person. Such paintings have always been more than just a record. They have been used to show the power, importance, virtue, beauty, wealth, taste, learning or other important qualities that characterize the sitter. It is one of the best ways to depict a person and show his/her character. I am always ready to meet all your wishes and preferences in your portrait, whether it's created as a personal painting or a piece of art for an official person. Contact me today to discuss your future portrait.</h2>
    ...
    <div class="lg:col-6">
    <img alt="home" src={potrait2} className='border-round-3xl max-w-full px-4 pot-2 lg:px-0'/>
    </div>
    <div class="lg:col-6">
        <div class="lg:grid">
            <div class="col-12">
