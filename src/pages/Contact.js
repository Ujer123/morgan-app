    ...
    return(
        <>
            ...
            <div className='lg:grid lg:flex justify-content-around'>
                ...
                <div className='lg:col-6 col-11 '>
                    ...
                    <div className="card flex justify-content-center">
                        <form onSubmit={formik.handleSubmit} className="flex flex-column gap-2">
                            ...
                            <Button type="submit" label="Submit" className="text-orange-500 bg-white border-orange-500 border-rounded-3xl sub-but"/>
                        </form>
                    </div>
                </div>
                ...
                <div className='lg:col-6 col-11  '>
                    <h2>Our Address</h2>
                    <p><i className="pi pi-building bg-black-alpha-50 p-1 mr-2"></i>2130 Fulton Street, San Diego, USA</p>
                    <p><i className="pi pi-phone bg-black-alpha-50 p-1 mr-2"></i>1-800-1234-567</p>
